                             ...
                             uint8_t maxNumberOfCredentialsPerUser)
{
    ...
    {
        P6_LOG("Failed to allocate array for lock credentials");
        return APP_ERROR_STOP_TIMER_FAILED;
    }
...
bool LockManager::ReadConfigValues()
{
    size_t outLen;
#if 1
    P6Config::ReadConfigValueBin(P6Config::kConfigKey_LockUser, reinterpret_cast<uint8_t *>(&mLockUser),
    ...
    P6Config::ReadConfigValueStr(P6Config::kConfigKey_LockUserName, mUserName, DOOR_LOCK_USER_NAME_BUFFER_SIZE, outLen);

    P6Config::ReadConfigValueBin(P6Config::kConfigKey_CredentialData, mCredentialData, sizeof(mCredentialData), outLen);

    P6Config::ReadConfigValueBin(P6Config::kConfigKey_UserCredentials, reinterpret_cast<uint8_t *>(mCredentials.Get()),
                          ...
                          DlCredentialRule credentialRule, const DlCredential * credentials, size_t totalCredentials)
{
    ...
    P6Config::WriteConfigValueBin(P6Config::kConfigKey_LockUser, reinterpret_cast<const uint8_t *>(&userInStorage),
                                     sizeof(EmberAfPluginDoorLockUserInfo));

    P6Config::WriteConfigValueBin(P6Config::kConfigKey_UserCredentials, reinterpret_cast<const uint8_t *>(mCredentials.Get()),
                                     sizeof(DlCredential));

    P6Config::WriteConfigValueStr(P6Config::kConfigKey_LockUserName, mUserName, sizeof(userName.size()));
                                ...
                                const chip::ByteSpan & credentialData)
{
    ...
    // Save user information in NVM flash
    P6Config::WriteConfigValueBin(P6Config::kConfigKey_Credential, reinterpret_cast<const uint8_t *>(&credentialInStorage),
